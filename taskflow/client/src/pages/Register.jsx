  ...
  return (
    <div style={styles.page}>
      <div style={styles.card}>
        ...
        <p style={styles.sub}>Start managing tasks today</p>

        {error && <div style={styles.error}>{error}</div>}

        <form onSubmit={submit}>
          <label style={styles.label}>Name</label>
          <input style={styles.input} type="text" name="name" value={form.name}
            onChange={handle} placeholder="Your name" required />
